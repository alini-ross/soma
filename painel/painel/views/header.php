    ...
    <aside class="main-sidebar sidebar-dark-secundary elevation-4">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link"><i class="nav-icon fas fa-tachometer-alt"></i><p>Equipamentos<i class="right fas fa-angle-left"></i></p></a>
            <ul class="nav nav-treeview"> 
              <li class="nav-item"><a href="<?=$actual_link?>/painel/listar-equipamentos" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Listar</p></a></li>
              <li class="nav-item"><a href="<?=$actual_link?>/painel/adicionar-equipamento" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Adicionar</p></a></li>
            </ul>
          </li>
          ...
          <li class="nav-item"><a href="<?=$actual_link?>/painel/configuracoes" class="nav-link"><i class="nav-icon fas fa-cog"></i><p>Configurações</p></a></li>
        </ul>
      </nav>
      <!-- /.sidebar-menu -->
      <!-- /.sidebar -->
